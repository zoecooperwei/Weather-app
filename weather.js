...
function requestData(cityName){
  ...
  $.getJSON("http://api.worldweatheronline.com/premium/v1/tz.ashx?key=eec9fdd5437e4c5eb7022637192710&q="+cityName+"&format=json",
    function(data){
...
window.onload = function geoLocalLocation() {
  ...
  if (navigator.geolocation){
    ...
    // });
    // map.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCIdv28vrMB39glyYY93ALvmNtl1g-gjJk@callback=success";
    map.src = "https://maps.googleapis.com/maps/api/staticmap?center="+lat +","+lon+ "&zoom=13&size=200x200&sensor=false&key=AIzaSyCIdv28vrMB39glyYY93ALvmNtl1g-gjJk";
  	$("#map").html(map);
